  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-7">
        ...
        <div class="mt-4">
          <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-dark">Get in Touch</a>
          <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-secondary">Learn More</a>
        </div>
      </div>

      <div class="col-md-5 text-center">
        <div class="profile-photo-wrapper">
          <img src="<?php echo e(asset('img/Fakhri Andika Pas Poto.jpg')); ?>" alt="Fakhri Andika" class="profile-photo img-fluid rounded" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6">
        ...
        <div class="mt-4">
          <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-dark">Get in Touch</a>
          <a href="<?php echo e(route('about')); ?>" class="btn btn-outline-secondary">Learn More</a>
        </div>
      </div>
...
<section class="section text-center lets-connect-section py-5">
  <div class="container">
    ...
    <a href="<?php echo e(route('contact')); ?>" class="btn btn-light">Get in Touch</a>
  </div>
</section>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lat_laravel1\resources\views/index.blade.php ENDPATH**/ ?>
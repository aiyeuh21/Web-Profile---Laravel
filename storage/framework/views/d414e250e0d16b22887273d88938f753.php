...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <p>
                Jika Anda memiliki pertanyaan atau memerlukan bantuan, silakan <a href="<?php echo e(route('contact')); ?>">hubungi kami</a>.
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lat_laravel1\resources\views/about.blade.php ENDPATH**/ ?>
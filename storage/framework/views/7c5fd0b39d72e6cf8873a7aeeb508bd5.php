...
<html lang="id">
  ...
  <body>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-5 text-center">
            <div class="profile-photo-wrapper">
              <img src="<?php echo e(asset('img/Fakhri Andika Pas Poto.jpg')); ?>" alt="Fakhri Andika" class="profile-photo" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="section text-center lets-connect-section">
      <div class="lets-connect-overlay"></div>
      <div class="container">
        <h2>Let’s Connect</h2>
        <p class="text-white mb-4">Open to professional discussions, collaboration, and career opportunities.</p>
        <a href="contact.html" class="btn btn-light">Get in Touch</a>
      </div>
    </section>
    <footer class="text-center py-3 bg-dark text-light">© 2026 Fakhri Andika</footer>
  </body>
</html>
<?php /**PATH D:\laragon\www\lat_laravel\resources\views/index.blade.php ENDPATH**/ ?>